...
<div class="container">
    ...
    <div class="d-flex justify-content-center">
        ...
        <div class="box shadow p-3" style="margin-left: 3rem; margin-top: 2rem">
            ...
            <p>(durée ~4h)</p>
            <ol>
                <li>Télécharger les scripts SQL de la base de données de démarrage (format mysql) : <a
                            href="doc/world-database.zip">Schéma de la base de données + data</a></li>
                <li>Créer une base de données, et initialiser cette dernière à l'aide des 2 scripts en question</li>
                <li><b>Adapter</b> le script <code>connect-db.php</code> en conséquence</li>
